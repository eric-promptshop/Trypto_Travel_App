...
- Budget Range: $${preferences.budgetMin} - $${preferences.budgetMax} ${preferences.currency || 'USD'} per person
...
Ensure all costs are in ${preferences.currency || 'USD'} and the total stays within budget.`;
}
  ...
  try {
    ...
    const itinerary: GeneratedItinerary = {
      ...
      destinations: [{
        ...
        coordinates: { latitude: 0, longitude: 0 }, // Would be geocoded in production
        countryCode: 'XX',
        timezone: 'UTC',
        weatherInfo: {
        ...
        localCurrency: preferences.currency || 'USD',
        languages: ['English'],
        safetyRating: 8,
        touristSeason: 'peak' as const,
        images: [],
        tags: [],
        createdAt: new Date(),
        updatedAt: new Date()
