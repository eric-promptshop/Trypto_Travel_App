-- Demo Account Setup with Correct Role Values
-- This script creates demo accounts using valid role enum values
...
-- Show created users
SELECT id, email, name, role FROM "users" WHERE id IN ('demo-traveler-001', 'demo-agent-001');