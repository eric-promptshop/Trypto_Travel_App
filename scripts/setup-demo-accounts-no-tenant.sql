-- Demo Account Setup without TenantId
-- This script creates demo accounts without specifying tenantId
...
-- Create Demo Users without tenantId (will use database default)
INSERT INTO "users" (id, email, name, role, "createdAt", "updatedAt")
VALUES 
  ('demo-traveler-001', 'demo@example.com', 'Demo Traveler', 'TRAVELER', NOW(), NOW()),
  ('demo-agent-001', 'demo-operator@example.com', 'Demo Tour Operator', 'AGENT', NOW(), NOW());
