-- Create Demo Users Script for Supabase
-- This script creates demo accounts for both traveler and tour operator personas
...
-- Note: This hash is for 'demo123' - you may need to generate a new one if your bcrypt settings differ
INSERT INTO "Account" (
  id,
  "userId",
  type,
...
-- Create some demo trips for the traveler
...
-- Create some demo content for the tour operator
INSERT INTO "Content" (
  id,
  "tenantId",
  type,
...
(
  ...
  10,
  true,
  '{"maxParticipants": 20, "operatorName": "Demo Tours", "included": ["Hotels", "Breakfast", "Guide", "Transport"], "highlights": ["Colosseum", "Vatican", "Uffizi Gallery", "Venice Canals"]}',
  NOW(),
  NOW(),
  'demo-operator-001',
  true
...
(
  ...
  14,
  true,
  '{"maxParticipants": 16, "operatorName": "Demo Tours", "included": ["Hotels", "Breakfast", "Guide", "JR Pass"], "highlights": ["Mt Fuji", "Kyoto Temples", "Tokyo Tower", "Hiroshima Peace Memorial"]}',
  NOW(),
  NOW(),
  'demo-operator-001',
  true
...
(
  ...
  8,
  true,
  '{"maxParticipants": 12, "operatorName": "Demo Tours", "included": ["Camping", "Meals", "Guide", "Permits"], "highlights": ["Inca Trail", "Machu Picchu", "Sacred Valley", "Cusco"]}',
  NOW(),
  NOW(),
  'demo-operator-001',
  false
...
SELECT 
  ...
  COUNT(*) as user_count 
FROM "User" 
WHERE email IN ('demo@example.com', 'demo-operator@example.com');